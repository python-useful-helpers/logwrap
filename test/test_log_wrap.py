...
class TestLogWrap(unittest.TestCase):
            ...
            [
                mock.call(
                    ...
                    msg=(
                        ...
                        "    # POSITIONAL_OR_KEYWORD:\n"
                        "    'test_arg1'={},\n"
                        ")".format(logwrap.pretty_repr(arg1, indent=8, no_indent_start=True))
                    ),
                ),
    ...
    def test_016_exceptions_blacklist(self):
        ...
        self.assertEqual([mock.call(level=logging.DEBUG, msg="Calling: \n'func'()")], log.mock_calls)
            ...
            [
                mock.call(
                    ...
                    msg=(
                        ...
                        "    'test_arg2'={},\n"
                        ")".format(
                            logwrap.pretty_repr(arg1, indent=8, no_indent_start=True),
                            logwrap.pretty_repr(arg2, indent=8, no_indent_start=True),
                        )
                    ),
                ),
...
class TestObject(unittest.TestCase):
    ...
    def test_002_override_skip_arg(self):
        class SkipArg(logwrap.LogWrap):
            def pre_process_param(self, arg):
                if "skip" in arg.name:
                    return None
                return arg
